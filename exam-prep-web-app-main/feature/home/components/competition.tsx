        ...
        <div className='py-10'>
            ...
            <div className=' grid grid-cols-3 gap-5'>
                ...
                <Card className=' flex-row p-5'>
                    <Image width={2000} height={2000} alt='exam' src={"/img/mock.png"} className='  w-full' />
                    <div className='  '>
                        <div>
                        ...
                        <CustomDialog className=' ' size='xl' title='' onOpenChange={(open) => setOpen(open)} open={open}
                            ...
                            <div className=' max-w-sm  space-y-3 mx-auto text-center'>
                                <Image width={2000} height={2000} alt='exam' src={"/img/mock.png"} className=' mx-auto h-28 w-28 ' />
                                <div>
